const PullRequestEventTests = {}

PullRequestEventTests["testEvents"] = {}
PullRequestEventTests["testEvents"]["closed"] = [
  {
    ...
    event: {
      ...
      repo: {
        ...
        url: "https://api.github.com/repos/timfitzzz/gatsby-theme-localization",
      },
      payload: {
        action: "closed",
        number: 1,
        pull_request: {
          ...
          head: {
            ...
            user: {
              ...
              followers_url: "https://api.github.com/users/onestopjs/followers",
              following_url:
              ...
              organizations_url: "https://api.github.com/users/onestopjs/orgs",
            ...
            repo: {
              ...
              ssh_url: "git@github.com:onestopjs/gatsby-theme-localization.git",
              clone_url:
                "https://github.com/onestopjs/gatsby-theme-localization.git",
              svn_url: "https://github.com/onestopjs/gatsby-theme-localization",
          ...
          base: {
            ...
            repo: {
              ...
              ssh_url: "git@github.com:timfitzzz/gatsby-theme-localization.git",
              clone_url:
                "https://github.com/timfitzzz/gatsby-theme-localization.git",
              svn_url: "https://github.com/timfitzzz/gatsby-theme-localization",
              homepage: "https://npmjs.com/package/gatsby-theme-localization",
              size: 3385,
              stargazers_count: 0,
              watchers_count: 0,
